    ...
    <main>
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-700 to-blue-500 text-white overflow-hidden min-h-screen flex items-center justify-center px-6">
        ...
        <div className="relative z-10 max-w-3xl text-center">
          ...
          >
            <button
              className="flex items-center gap-2 bg-yellow-400 text-blue-900 font-semibold px-6 py-3 rounded-lg hover:bg-yellow-300 transition"
              onClick={handleRedirect}
            >
              <FaMoneyBillWave /> Apply Now
            </button>
            <button
              className="flex items-center gap-2 border border-white/50 px-6 py-3 rounded-lg hover:bg-white/10 transition"
              onClick={handleRedirect}
            >
              <FaLock /> Learn More
            </button>
